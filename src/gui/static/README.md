# dollarydoos desktop client

The dollarydoos wallet ships with a web interface which can be ran from the browser and/or Electron.

The project contains both the source (src) and target (dist) files of this web interface.

## Prerequisites

The dollarydoos web interface requires Node 8.10.0 or higher, together with NPM 5.6 or higher.
...
While event.dollarydoos.io is not working, we will have to run the purchase API locally.
